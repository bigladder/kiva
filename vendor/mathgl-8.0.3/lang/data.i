...
public:
	...
	inline mglData HistL(const mglData &w, long n,mreal v1=0,mreal v2=1) const
	...
	* Parameter \a iter set maximal number of iterations (0 is automatic). */
	inline void Mode(const mglData &mask, const mglData &pot, const char *how, double kdx=0, long iter=0)
	{	mgl_data_mode(this, &mask, &pot, how, kdx, iter);	}
	inline void Mode(const mglData &mask, const char *how, double kdx=0, long iter=0)
