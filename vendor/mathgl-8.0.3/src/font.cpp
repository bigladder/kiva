...
unsigned mglFont::Parse(const wchar_t *s) const
{
	...
	for(long k=0;mgl_act_symb[k].kod;k++)	// accents
	...
	else if(!wcscmp(s,L"1"))		res = MGL_FACE_FACTOR;
	else if(!wcscmp(s,L"2"))		res = MGL_FACE_FACTOR*2;
	else if(!wcscmp(s,L"3"))		res = MGL_FACE_FACTOR*3;
	else if(!wcscmp(s,L"4"))		res = MGL_FACE_FACTOR*4;
	else if(!wcscmp(s,L"5"))		res = MGL_FACE_FACTOR*5;
	else if(!wcscmp(s,L"6"))		res = MGL_FACE_FACTOR*6;
	else if(!wcscmp(s,L"7"))		res = MGL_FACE_FACTOR*7;
	else if(!wcscmp(s,L"8"))		res = MGL_FACE_FACTOR*8;
	else if(!wcscmp(s,L"9"))		res = MGL_FACE_FACTOR*9;
	return res;
}
//-----------------------------------------------------------------------------
